...
ActiveRecord::Schema.define(version: 2020_04_07_055958) do
  ...
  create_table "keywords", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["description"], name: "description_UNIQUE", unique: true
  end
  ...
  create_table "products_stores", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
